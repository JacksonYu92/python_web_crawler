...
async def main():
    ...
    background = await page.Jeval(".JDJRV-bigimg > img", "el=>el.src")
    gap = await page.Jeval(".JDJRV-smallimg > img", "el=>el.src")

    request.urlretrieve(background, "background.png")
    request.urlretrieve(gap, "gap.png")
